...
screen main_menu():
    ...
    fixed:
        ...
        if main_menu:
            ...
            imagebutton auto "gui/mm_start_%s.png" xpos 265 ypos 611 action Start ()
        ...
        #textbutton _("Load") action ShowMenu("load")
        imagebutton auto "gui/mm_save_%s.png" xpos 265 ypos 720 action ShowMenu("load")
            

        #textbutton _("Preferences") action ShowMenu("preferences")
        imagebutton auto "gui/mm_settings_%s.png" xpos 265 ypos 829 action ShowMenu("preferences")
